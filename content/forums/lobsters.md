...
Author here. v0.1.0, Apache-2.0, alpha. Thot Secure is a defensive SOAR/CSPM: normalized events, YAML detection rules (26 shipped), a risk score, a policy-as-code decision (9 shipped policies), then a playbook (15 shipped) that carries a rollback unless it is explicitly marked irreversible. Four design decisions below, including the parts I'm not sure about. Repo: https://github.com/thot-corp/thot-secure
